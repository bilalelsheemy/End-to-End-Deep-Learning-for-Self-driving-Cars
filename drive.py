...
#from Behavioral_Cloning_Pipeline_based_on_Keras import image_preprocess
...
def image_preprocess(img):
    ...
    #print(np.asarray(eulized_img).shape)
    return YUV_img
#################
...
def telemetry(sid, data):
    if data:
      ...
      image_prep = image_preprocess(image_array)
      steering_angle = float(model.predict(image_prep[None, :, :, :], batch_size=1))
